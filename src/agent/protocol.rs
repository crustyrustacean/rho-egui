...
mod tests {
    ...
    #[test]
    fn tool_call() {
        match parse(r#"{"method":"tool/call","params":{"name":"read_file","arguments":"{}"}}"#) {
    ...
    fn approval_request() {
        match parse(
            r#"{"method":"approval/request","params":{"tool":"t","arguments":"a","risk":"low"}}"#,
        ) {
            Some(RhoEvent::ApprovalRequest {
                tool,
                arguments,
                risk,
            }) => {
